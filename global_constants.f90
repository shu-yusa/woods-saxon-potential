...
!--------------------------------------------------------------------!
      ...
      parameter(r0=1.27d0, Mn=938.943d0, hbar=197.327d0)
      parameter(A=208.0d0, ALPHA=0.67d0)!V0=51.0d0, Vso=22.44d0, )
      parameter(V0=51.0d0-33.0d0*(A - 2.0d0*Z)/A, Vso=0.44d0*V0)
      end module 
!====================================================================!
